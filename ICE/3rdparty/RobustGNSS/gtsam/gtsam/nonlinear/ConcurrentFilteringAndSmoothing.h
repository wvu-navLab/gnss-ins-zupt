...
void GTSAM_EXPORT synchronize(ConcurrentFilter& filter, ConcurrentSmoother& smoother);

/**
 * The interface for the 'Filter' portion of the Concurrent Filtering and Smoother architecture.
 */
class GTSAM_EXPORT ConcurrentFilter {
public:
 ...
 */
class GTSAM_EXPORT ConcurrentSmoother {
public:
